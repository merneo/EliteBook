...
class ffmpeg_reader:
        ...
        def probe(self):
                ...
                # FIX 1: Convert to string before checking isdigit
        ...
        def read(self):
                ...
                # FIX 2: Check type instead of value equality to avoid numpy broadcasting errors
                if type(self.video) is tuple:
                        self.record(self.numframes)
