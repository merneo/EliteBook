# Arch Linux Installation Guide - AMD Hardware

**Version:** 1.0.0  
**Last Updated:** December 2, 2025  
**Language:** US English (Academic Publication Standard)  
**Purpose:** Arch Linux installation guide with AMD CPU microcode and graphics drivers

This document provides a comprehensive guide for installing Arch Linux on AMD-based x86-64 systems with full-disk encryption, Btrfs filesystem, and a minimal window manager setup. This guide includes AMD-specific microcode updates and AMD graphics drivers (AMD Radeon integrated and discrete graphics).
...
- **Minimal Window Manager**: Wayland compositor setup with AMD graphics drivers
- **AMD CPU Microcode**: AMD processor microcode updates for security and stability
- **AMD Graphics Drivers**: Mesa, Vulkan, and VA-API drivers for AMD Radeon graphics
- **Academic Documentation**: Comprehensive theoretical foundations, references, and citations

**Target Audience:**
- System administrators installing Arch Linux on AMD-based hardware
- Users with AMD processors and Radeon graphics (integrated or discrete)
- Educational institutions teaching Linux system administration on AMD hardware
- Researchers documenting Linux installation procedures for AMD systems

**Prerequisites:**
- AMD x86-64 compatible processor
- AMD Radeon graphics (integrated APU graphics or discrete Radeon GPU)
...
**Last Updated:** December 2, 2025  
**Author:** Arch Linux Installation Guide - AMD Hardware  
...
**amdgpu** is the kernel module for modern AMD Radeon graphics (GCN architecture and newer). For older AMD GPUs (pre-GCN), use **radeon** instead.

**AMD GPU Hardware Support:**

- **amdgpu**: AMD GCN (Graphics Core Next) architecture and newer
  - Radeon HD 7000 series and newer
  - Radeon RX series (RX 400, RX 500, RX 6000, RX 7000)
  - Radeon Vega (Vega 8, Vega 10, Vega 11)
  - RDNA/RDNA2/RDNA3 architecture
- **radeon**: Pre-GCN AMD GPUs (legacy)
